...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                list.Price = SD.GetPriceBasedOnQuantity(list.Count, list.Price, list.Price, list.Price);
        ...
        public IActionResult plus(int cartId)
        {
            ...
            cart.Count++;
            cart.Price = SD.GetPriceBasedOnQuantity(cart.Count, cart.Price, cart.Price, cart.Price);
            _unitOfWork.Save();
        ...
        public IActionResult Summary()
        {
            ...
            {
                OrderHeader = new Models.OrderHeader(),
                ListCarts = _unitOfWork.ShoppingCart.GetAll(c => c.ApplicationUserId == claim.Value,
